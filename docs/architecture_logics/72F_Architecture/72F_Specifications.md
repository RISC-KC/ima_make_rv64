# 72F Architecture
Basically same as 59F
Now supports RV32M, 64M Extension.
No architectural difference between 72F and 59F in module design level.
Only difference is the ALU logics. 
Additional ALUop added for implementing the "M" Extension's multiplication, division, remnant calculation. 
ALU's calculation about "M" Extension has been added too.

ISA : RISC-V RV64IM, Zicsr, Zifencei, mret
